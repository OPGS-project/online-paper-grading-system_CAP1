...
export default function AddAssignmentShort() {
    ...
    return (
        <div className="container-fluid d-flex flex-column align-items-center justify-content-center">
            <div className="right-sidebar" style={{marginRight: 130}}>
            ...
            <div className="header-short-assignment">
                ...
                <div>
                    ...
                    <select
                        ...
                        style={{ height: 38, borderRadius: 6, width: 80 }}
                    ...
                    <button style={{ marginLeft: 20 }} className="btn btn-primary" onClick={handleSaveQuestion}>
                        Lưu
                    </button>
                </div>
            </div>
            ...
            {items.map((item) => (
                <div
                    className={`content-add-item shadow-sm ${
                        newItems.some((newItem) => newItem.id === item.id) ? 'add-item-animation' : ''
                    }`}
                    key={item.id}
                >
                    <div className="line"></div>
